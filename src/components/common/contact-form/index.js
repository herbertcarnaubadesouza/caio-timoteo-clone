...
const schema = yup
  .object({
    ...
    user_message: yup.string().required("O campo mensagem é obrigatório."),
  })
  .required();
      ...
      <div className={styles.contactform_wrapper}>
        <div className={styles.contactform_texts}>
          <div>
            ...
            <p>Monomito Filmes</p>
            <p>Itaim Paulista / SP</p>
            <p>CNPJ 29.792.874/0001-00</p>
          </div>
          <div className={styles.contactform_texts_completeAdress}>
            <p>
              Rua Ilha de São Francisco, 283 - Itaim Paulista, São Paulo - SP,
              08110-310
            </p>
          </div>
          <div>
